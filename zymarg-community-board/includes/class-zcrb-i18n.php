    ...
    public static function default_strings(): array {
        return array(
            'en' => array(
                ...
                'too_many_images'          => 'You can upload a maximum of %d images.',
                ...
                'similar_requests_found'   => 'Similar requests found:',
                'no_similar_found'         => 'No similar requests found',
                'check_existing'           => 'Check for existing requests',
                'bulk_approved_notice'     => '%d request(s) approved.',
                'empty_state_title'        => 'No Requests Yet',
                'empty_state_subtitle'     => 'Be the first to post what you need! Our vendor community is ready to help.',
            ),
            'bn' => array(
                ...
                'too_many_images'          => 'আপনি সর্বোচ্চ %d টি ছবি আপলোড করতে পারেন।',
                ...
                'search_placeholder'       => 'রিকোয়েস্ট অনুসন্ধান করুন...',
                'search_button'            => 'অনুসন্ধান',
                'filter_all'               => 'সব স্ট্যাটাস',
                'filter_in_progress'       => 'চলমান',
                'filter_fulfilled'         => 'পূরণ হয়েছে',
                'similar_requests_found'   => 'অনুরূপ রিকোয়েস্ট পাওয়া গেছে:',
                'no_similar_found'         => 'অনুরূপ কোনো রিকোয়েস্ট পাওয়া যায়নি',
                'check_existing'           => 'বিদ্যমান রিকোয়েস্ট দেখুন',
                'bulk_approved_notice'     => '%d টি রিকোয়েস্ট অনুমোদিত হয়েছে।',
                'empty_state_title'        => 'এখনও কোনো রিকোয়েস্ট নেই',
                'empty_state_subtitle'     => 'আপনার প্রয়োজন প্রথমে পোস্ট করুন! আমাদের বিক্রেতা কমিউনিটি সাহায্য করতে প্রস্তুত।',
            ),
        );
    }
